package dansplugins.simpleskills.data.objects;
...
public class PlayerRecord implements Savable, Cacheable {
    ...
    public PlayerRecord(PersistentData persistentData, MessageService messageService, ConfigService configService, ExperienceCalculator experienceCalculator, Logger logger, UUID playerUUID) {
    ...
    public PlayerRecord(Map<String, String> data, PersistentData persistentData, MessageService messageService, ConfigService configService, ExperienceCalculator experienceCalculator, Logger logger) {
        this.persistentData = persistentData;
        this.messageService = messageService;
        this.configService = configService;
        this.experienceCalculator = experienceCalculator;
    ...
    public void incrementExperience(int ID) {
        ...
        AbstractSkill skill = persistentData.getSkill(ID);
    ...
    public void sendInfo(CommandSender commandSender) {
        ...
        for (int skillID : getKnownSkills()) {
            ...
            AbstractSkill skill = persistentData.getSkill(skillID);
            if (skill == null) {
                continue;
            }
