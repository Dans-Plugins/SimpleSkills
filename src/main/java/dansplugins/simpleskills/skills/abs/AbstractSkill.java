...
public abstract class AbstractSkill implements Listener {
     ...
     */
    @SafeVarargs
    public AbstractSkill(ConfigService configService, Logger logger, PersistentData persistentData, SimpleSkills simpleSkills, MessageService messageService, @NotNull String name, @NotNull Class<? extends Event>... triggers) {
     ...
     * @see #AbstractSkill(ConfigService, Logger, PersistentData, SimpleSkills, MessageService, String, Class[])
     */
