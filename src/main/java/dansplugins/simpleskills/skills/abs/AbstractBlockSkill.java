package dansplugins.simpleskills.skills.abs;
...
public abstract class AbstractBlockSkill extends AbstractSkill {
     ...
     */
    public AbstractBlockSkill(ConfigService configService, Logger logger, PersistentData persistentData, SimpleSkills simpleSkills, MessageService messageService, @NotNull String name) {
        super(configService, logger, persistentData, simpleSkills, messageService, name, BlockBreakEvent.class, BlockPlaceEvent.class, PlayerInteractEvent.class);
    }
