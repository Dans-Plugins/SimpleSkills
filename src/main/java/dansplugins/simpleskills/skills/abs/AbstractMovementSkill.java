...
public abstract class AbstractMovementSkill extends AbstractSkill {
     ...
     * </p>
     */
    public AbstractMovementSkill(ConfigService configService, Logger logger, PersistentData persistentData, SimpleSkills simpleSkills, MessageService messageService, @NotNull String name) {
        super(configService, logger, persistentData, simpleSkills, messageService, name, PlayerMoveEvent.class);
    }
