...
public class LocalConfigService {
    ...
    public void saveMissingConfigDefaultsIfNotPresent() {
        ...
        if (nms.contains("v1_13_R1")) {
            if (!isSet("MCVersion.1_14")) {
                getConfig().set("MCVersion.1_14", false);
            }
            if (!isSet("MCVersion.1_16")) {
                getConfig().set("MCVersion.1_16", false);
            }
            if (!isSet("MCVersion.1_17")) {
                getConfig().set("MCVersion.1_17", false);
            }
        }
        if (nms.contains("v1_13_R2")) {
            if (!isSet("MCVersion.1_14")) {
                getConfig().set("MCVersion.1_14", false);
            }
            if (!isSet("MCVersion.1_16")) {
        ...
        if (nms.contains("v1_14_R1")) {
            if (!isSet("MCVersion.1_14")) {
                getConfig().set("MCVersion.1_14", true);
            }
            if (!isSet("MCVersion.1_16")) {
                getConfig().set("MCVersion.1_16", false);
            }
        ...
        if (nms.contains("v1_16_R1")) {
            if (!isSet("MCVersion.1_14")) {
                getConfig().set("MCVersion.1_14", true);
            }
            if (!isSet("MCVersion.1_16")) {
                getConfig().set("MCVersion.1_16", true);
            }
            if (!isSet("MCVersion.1_17")) {
                getConfig().set("MCVersion.1_17", false);
            }
        }
        if (nms.contains("v1_16_R2")) {
            if (!isSet("MCVersion.1_14")) {
                getConfig().set("MCVersion.1_14", true);
            }
            if (!isSet("MCVersion.1_16")) {
        ...
        if (nms.contains("v1_17_R1")) {
            ...
            if (!isSet("MCVersion.1_17")) {
                getConfig().set("MCVersion.1_17", true);
            }
        }
        if (nms.contains("v1_18_R1")) {
            if (!isSet("MCVersion.1_14")) {
                getConfig().set("MCVersion.1_14", true);
            }
            if (!isSet("MCVersion.1_16")) {
